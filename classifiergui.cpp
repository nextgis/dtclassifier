...
ClassifierGui::ClassifierGui( QWidget* parent, Qt::WFlags fl )
    : QDialog( parent, fl )
{
  setupUi( this );
  ...
  QString format( "<html><body><h3>%1</h3>%2<h3>%3</h3>%4<p><a href=http://svn.qgis.org/api_doc/html>"
                  ...
                  "<h4>classifier.h, classifier.cpp</h4>%12"
                  "<h4>classifiergui.ui</h4>%13"
                  "<h4>classifiergui.cpp, classifiergui.h</h4>%14"
                  "<h4>classifier.qrc</h4>%15"
                  "<h4>classifier.png</h4>%16"
                  "<h4>README</h4>%17"
...
ClassifierGui::~ClassifierGui()
{
}

void ClassifierGui::on_buttonBox_accepted()
{
  //close the dialog
  accept();
}

void ClassifierGui::on_buttonBox_rejected()
{
  reject();
}

void ClassifierGui::on_buttonBox_helpRequested()
{
